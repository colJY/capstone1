...
//        userProfileStatus = (TextView) findViewById(R.id.find_txtUsername);
        sendMessageRequestButton = (Button) findViewById(R.id.find_requestButton);
...
//                userProfileStatus.setText(userStatus);
    ...
    private void SendChatRequest() {
        if(sendMessageRequestButton.getText().equals("Cancel Invited")){
            ...
            sendMessageRequestButton.setText("친구 추가");
            return;
        }
        chatRequestRef.child(senderUserId).child(receiverUserId)
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                ...
                                                sendMessageRequestButton.setText("초대 취소");
                                            }
                                        }
                                    });
                        }
